...
void main() {
  test('profile edit page delegates visual form pieces to flat components', () {
    final source = File('lib/shared_pages/profile_edit/profile_edit_widget.dart')
        .readAsStringSync();

    expect(source, contains("'/components/profile_avatar_picker.dart'"));
    expect(source, contains("'/components/profile_edit_fields.dart'"));
    expect(source, contains("'/components/profile_save_bar.dart'"));
    ...
    expect(source, contains('ProfileSaveBar('));
