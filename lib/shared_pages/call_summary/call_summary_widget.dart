  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final callSummaryUsersRecord = snapshot.data!;
                                ...
                                rating: createURatingStruct(
                                  average:
                                      functions.recalculateRatingWithNewReview(
                                          callSummaryUsersRecord
                                              .rating.totalReviews,
                                          callSummaryUsersRecord.rating.average,
                                          _model.rait!),
                                  fieldValues: {
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  ...
                                  image: CachedNetworkImageProvider(
                                    callSummaryUsersRecord.photoUrl,
                                  ),
                                ),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      callSummaryUsersRecord.displayName,
                                      maxLines: 2,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
