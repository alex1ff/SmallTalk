...
- Положительные сценарии используют платную подписку и active gift-only access;
  отдельный отрицательный сценарий сохраняет `subscription: null` и пустой
  gift bucket. Trial overrides сохранены.
